      ...
      <div className="about-container-text">
        <div className="about-container-text-details">
          <div className="about-container-text-details-description">
            ...
            <p>
              At Willing Workers, we are a organization dedicated to assisting
              and supporting individuals with intellectual and developmental
              disabilities. Our mission is to promote independence,
              self-advocacy, and overall well-being through community
              integration training and the development of healthy habits. We
              strive to improve the quality of life for the individuals we serve
              by focusing on areas such as safety, personal health and hygiene,
              nutrition, physical fitness, and emergency preparedness. At
              Willing Workers, we believe in the inherent worth and potential of
              every individual and are committed to helping those with
              intellectual and developmental disabilities lead fulfilling and
              independent lives. We also ensure that individuals at Willing
              Workers perform to their highest potential and become full
            ...
            <div className="about-container-text-values">
              <h1>Our Values</h1>
              <p>
                Our values are at the core of who we are as employees of Willing
                Workers. They guide our interactions with the individuals we
                serve, their families, our staff, the community, and each other.
                We strive to embody these values in everything we do and make
                them a fundamental part of our organizational culture.
              </p>

              <p>
                By adhering to an individual-centered approach, we put the needs
                and well-being of the individuals we serve at the forefront of
                all our actions and decisions. We empower individuals to take an
                active role in their own growth and development, and strive to
                create an inclusive environment where everyone feels valued and
                respected. We work closely with families, staff, and the
                community to provide the best possible support and services. We
                are committed to continuously seeking out new and innovative
                ways to improve our services and support while taking
                responsibility for our actions and decisions, and being
                transparent in our communication and reporting.
              </p>

              <p>
                Through our values of compassion, dignity, diversity,
                excellence, and honesty, we care deeply about the thoughts and
                feelings of those around us, treat all individuals with respect,
                honor, and fairness, celebrate and embrace the differences that
                make us stronger, strive to deliver the highest quality support
                and services at all times, and prioritize honesty and
                transparency in our communication in order to build trust.
                Together, these values form the foundation of our mission to
                support and empower the individuals we serve.
              </p>
